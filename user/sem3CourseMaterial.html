                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="../Faculties/faculties.html" class="dropdown-item">Faculty Members</a>
                            </div>
                        </div>
                    </div>
...
<!--navbar ends-->
    ...
    <section id="course">
        ...
        <div class="container">                 
                    <ul>
                        <br/><br/> <li ><a href="#">Object Oriented design and Programming-II (ICE-2101)</a></li> <br/>
                        <li ><a href="#">Object Oriented design and Programming-I Laboratory (ICE-2102)</a></li><br/>
                        <li ><a href="#">Discrete Mathematics (ICE-2103)</a></li><br/>
                        <li ><a href="#">Mathematics-III (ICE-2105)</a></li><br/>
                        <li ><a href="#">Foreign Language (French) (ICE-2107)</a></li><br/>
                        <li ><a href="#">Foreign Language (German) (ICE-2107)</a></li><br/>
                        <li ><a href="#">Economics (ICE-2109)</a></li>
                        <li><a href="#">Digital Logic Design (ICE-2111)</a></li>
                        <li><a href="#">Digital Logic Design Laboratory (ICE-2112)</a></li>
