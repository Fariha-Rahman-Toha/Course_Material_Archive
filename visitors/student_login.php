...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "SELECT * FROM login_student WHERE student_name='$username' AND Password='$password'";
        ...
        if($count==1)
        {
               ...
               $_SESSION['student_login'] = "<div class='success'>Login Successful.</div>";
        ...
        else
        {
            ...
            $_SESSION['student_login'] = "<div class='error text-center'>Username or Password did not match.</div>";
