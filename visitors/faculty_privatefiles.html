    ...
    <section class="semester">
        ...
        <section class="semester">
            <div class="container" style="padding: 0; width:60%; margin: 0; align-items: center;">
                <iframe src="https://script.google.com/macros/s/AKfycbxKxAY1uctc1ylZ1k0uGoMU3p-nPRVpTPjoXzq6Y3PxWI_8D_3Piki7ZtsyiZPh4U3BZg/exec"
                width="600" height="250"  style="align-items: center;"></iframe>
                    </div>
    </section>
